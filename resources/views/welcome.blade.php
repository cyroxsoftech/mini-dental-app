                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="mb-2 text-gray-900 h4">Clinic ID</h1>
                                    <p class="mb-4">Enter your clinic ID before proceeding!</p>
                                </div>
                                <form method="post" action="{{ route('clinic.verify') }}" class="user">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('clinicId') is-invalid  @enderror"
                                            id="clinic-reference" aria-describedby="emailHelp"
